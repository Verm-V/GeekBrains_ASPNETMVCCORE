...
- [ ] *Вернитесь к вашему старому проекту по отображению графиков с агентов мониторинга. Сделайте новое приложение, 
...
Задание 1 и 2.  
Создал приложение WinForms. Один поток в приложении отвечает за создание и вывод чисел Фибоначчи на форму. Поток в нормальном состоянии находится 
